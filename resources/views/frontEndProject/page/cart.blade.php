        ...
        <div class="container">
            <div class="cart-item">
                    ...
                    <table>
                        ...
                        <thead>
                            ...
                            <th>Remove</th>
                                ...
                                @foreach (session("cart") as $item=>$detail)
                                    <tr >
                                        <td >
                                            <div class="image"><img src="{{asset("image/".$detail["img"])}}" alt=""></div>
                                        </td>
                                        <td>
                                           {{ $detail["name"] }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{route("cart.remove",["watchId"=>$item])}}" style="color:black;"><i class="fa-solid fa-xmark"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
                ...
                <div class="summary">
                    ...
                    <div class="total">
                        <p>Total</p>
                        <p>USD <span>${{$total+24}}</span></p>
                    </div>
                    <a href="{{route("checkout.index")}}">
                        <div class="checkout">Go To Checkout</div>
                    </a>
                </div>
            </div>
        </div>
